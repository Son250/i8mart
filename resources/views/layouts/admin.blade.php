...
<body>
    <div id="warpper" class="nav-fixed">
        <nav class="topnav shadow navbar-light bg-white d-flex">
            <div class="navbar-brand"><a href="{{ url('admin') }}">UNITOP ADMIN</a></div>
            <div class="nav-right ">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="{{ route('returnWebsite') }}">Trở về Website</a>
        ...
        <div id="page-body" class="d-flex">
            <div id="sidebar" class="bg-white">
                ...
                <ul id="sidebar-menu">
                    ...
                    {{-- <li class="nav-link {{ $module_active == 'comments' ? 'active' : '' }}">
                        ...
                        <i class="arrow fas fa-angle-down"></i>
                        <ul class="sub-menu">
                            <li><a href="{{ url('admin/comments/add') }}">Thêm mới</a></li>
                            <li><a href="{{ url('admin/comments/list') }}">Danh sách</a></li>
                            <li><a href="{{ url('admin/comments/cat/list') }}">Danh mục</a></li>
                        </ul>
                    </li> --}}
