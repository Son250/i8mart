...
@section('content')
    <div id="main-content-wp" class="checkout-page">
        ...
        <form method="POST" action="{{ route('checkoutStore') }}" name="form-checkout">
            @csrf
                ...
                <div class="section" id="order-review-wp">
                    ...
                    <div class="section-detail">
                        <table class="shop-table">
                            ...
                            <tfoot>
                                <tr class="order-total">
                                    <td>Tổng đơn hàng:</td>
                                    <td><strong class="total-price">{{ number_format($totalPrice, '0', ',', '.') }}đ
                                        </strong>
                                    </td>
                                </tr>
                            </tfoot>
                        ...
                        <div class="place-order-wp clearfix">
                            <input type="submit" id="order-now" name="btnCheckOut" value="Đặt hàng">
                        </div>
        ...
        {{-- <form action="{{ url('vnpay_payment') }}" method="POST">
            @csrf
            <button type="submit" name="redirect">Xác nhận thanh toán online</button>
        </form> --}}
    </div>
@endsection
